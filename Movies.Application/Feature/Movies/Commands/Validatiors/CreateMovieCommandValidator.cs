...
namespace Movies.Application.Feature.Movies.Commands.Validatiors
{
	public class CreateMovieCommandValidator : AbstractValidator<CreateMovieCommand>
	{
		...
		private async Task<bool> ValidateSlug(CreateMovieCommand movie, string slug, CancellationToken cancellationToken=default)
		{
